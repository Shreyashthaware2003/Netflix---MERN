...
function Register() {
    ...
    return (
        <>
            ...
            {/* footer */}
            <section class=" py-8 bg-black border-t">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex items-center justify-between gap-6">
                        ...
                        <div class="flex items-center gap-4">
                            <a href="javascript:;"
                                class="border border-gray-300 p-2 rounded-full aspect-square text-gray-700 transition-all duration-300 hover:text-red-600 hover:border-red-600 focus-within:outline-0 focus-within:text-red-600 focus-within:border-red-600">
